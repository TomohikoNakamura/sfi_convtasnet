'''Borrowed from https://github.com/pfnet-research/meta-tasnet.
'''
...
class TCNLayer(nn.Module):
    ...
    """
    def __init__(self, generated, E_1, E_2, B, H, Sc, kernel, residual_bias, padding, dilation=1, num_groups=8):
        """
        Arguments:
        ...
        self.norm_1 = GroupNormWrapper(generated, E_1, E_2, num_groups, H, eps=1e-08)
        self.prelu_1 = nn.PReLU()
        self.conv1d = Conv1dWrapper(generated, E_1, E_2, B, H, 1, bias=False)

        self.norm_2 = GroupNormWrapper(generated, E_1, E_2, num_groups, H, eps=1e-08)
...
class MaskingModule(nn.Module):
    ...
    """
    def __init__(self, generated, E_1, E_2, N, B, H, layer, stack, kernel=3, residual_bias=False, partial_input=False, num_groups=8):
        """
        Arguments:
            generated {bool} -- True if you want to use the generated weights
            E_1 {int} -- Dimension of the instrument embedding
        ...
        self.norm_1 = GroupNormWrapper(generated, E_1, E_2, num_groups, self.in_N, eps=1e-8)
        self.prelu_1 = nn.PReLU()
        self.in_conv = Conv1dWrapper(generated, E_1, E_2, self.in_N, B, 1, bias=False)
        self.norm_2 = GroupNormWrapper(generated, E_1, E_2, num_groups, B, eps=1e-8)
        self.prelu_2 = nn.PReLU()

        self.tcn = nn.ModuleList([TCNLayer(generated, E_1, E_2, B, H, B, kernel, residual_bias, dilation=2**i, padding=2**i, num_groups=num_groups) for _ in range(stack) for i in range(layer)])

        self.norm_3 = GroupNormWrapper(generated, E_1, E_2, num_groups, B, eps=1e-8)
        self.prelu_3 = nn.PReLU()
        self.mask_output = Conv1dWrapper(generated, E_1, E_2, B, N, 1, bias=False)
        self.norm_4 = GroupNormWrapper(generated, E_1, E_2, num_groups, N, eps=1e-8)
